...
from src.core.exceptions import EdgeNotFoundError, StorageError
from src.core.models import Edge
from src.infrastructure.storage.plugins.base import EdgeStoragePlugin
from src.infrastructure.storage.plugins.utils import validate_pagination
...
from ..utils.serialization import deserialize_edge, serialize_edge
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            for key, data in edges_data.items():
                self._edges[key] = deserialize_edge(data)
    ...
    async def create_edge(self, edge: Edge) -> Edge:
        ...
        try:
            ...
            await save_json_file(
                self.edges_file, {k: serialize_edge(e) for k, e in self._edges.items()}
            )
