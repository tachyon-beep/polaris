...
from src.core.exceptions import NodeNotFoundError, StorageError
from src.core.models import Node
from src.infrastructure.storage.plugins.base import NodeStoragePlugin
...
from ..utils.serialization import deserialize_node, serialize_node
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            for name, data in nodes_data.items():
                self._nodes[name] = deserialize_node(data)
    ...
    async def create_node(self, node: Node) -> Node:
        ...
        try:
            ...
            await save_json_file(
                self.nodes_file, {name: serialize_node(n) for name, n in self._nodes.items()}
            )
