...
- Finding strongly connected components (subgraphs where nodes are mutually reachable following edge direction)
...
class ComponentAnalysis:
    ...
    def _tarjan_scc(
        ...
        Args:
            ...
            strongly_connected_components (List[Set[str]]): List to collect strongly connected components.
        """
