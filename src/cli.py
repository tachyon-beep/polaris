...
Example Usage:
    python -m src.cli add @data/graph_data.json
    python -m src.cli add-nodes '{"name": "example", "entity_type": "CONCEPT"}'
...
from .core.models import Edge, EdgeMetadata, Node, NodeMetadata, NodeMetrics
...
def get_data_dir() -> str:
    ...
    The data directory is located at '../data' relative to the src directory.
